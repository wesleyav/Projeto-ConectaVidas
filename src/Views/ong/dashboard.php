...
<section class="text-center mt-5 pt-5">
    <h1 class="fw-bold display-5 mt-4 text-primary">Perfil da ONG</h1>
...
<main class="container-fluid mt-4 pt-2">
    ...
    <div class="row g-4 px-3 px-md-5">
                ...
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
                    <div class="d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                        <img src="<?= htmlspecialchars($ong['logo'] ?? '/img/co-an-ft3.png') ?>"
                            alt="Logo ONG"
                            class="perfil-foto **rounded-circle** border border-3 border-success mb-3 mb-md-0 me-md-3"
                            id="profilePhoto" 
                    ...
                    <div class="d-flex gap-2 flex-wrap justify-content-center **justify-content-md-end**"> <button class="btn btn-outline-primary"
        ...
        <div class="col-12 col-lg-7"> <section class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12 col-sm-6"> <label class="form-label fw-semibold">CNPJ</label>
        ...
        <div class="col-12 col-lg-5"> <section class="card shadow-sm mb-4">
                            ...
                            <?php foreach ($campanhas as $c): ?>
                                <div class="list-group-item py-3">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row gap-2"> <a href="/?url=campanha/view&id=<?= (int)$c['id_campanha'] ?>" class="btn btn-outline-primary btn-sm"><i class="bi bi-file-earmark-text"></i> Relatório</a>
        ...
        <div class="modal fade" id="editarPerfilModal" tabindex="-1" aria-labelledby="editarPerfilLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg modal-fullscreen-sm-down">
                <form class="modal-content" id="editarPerfilForm" method="POST" action="/?url=ong/update">
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold" id="editarPerfilLabel">Editar Perfil da ONG</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                    </div>

                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-12 col-md-6"> <label class="form-label">Nome Fantasia</label>
                    ...
                    <div class="modal-footer flex-wrap gap-2">
                        ...
                        <button type="submit" class="btn btn-primary w-100 w-sm-auto">Salvar alterações</button>
                    </div>
                </form>
            </div>
        </div>
